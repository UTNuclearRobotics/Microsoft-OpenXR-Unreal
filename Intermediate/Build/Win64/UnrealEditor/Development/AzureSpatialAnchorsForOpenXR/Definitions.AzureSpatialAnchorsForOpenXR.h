#undef AZURESPATIALANCHORSFOROPENXR_API
...
#define UE_MODULE_NAME "AzureSpatialAnchorsForOpenXR"
...
#define MICROSOFTOPENXR_API DLLIMPORT
#define AZURESPATIALANCHORSFOROPENXR_API DLLEXPORT
#define AZURESPATIALANCHORS_API DLLIMPORT
