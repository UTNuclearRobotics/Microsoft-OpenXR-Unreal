...
#define XR_MSFT_holographic_remoting_SPEC_VERSION   3
#define XR_MSFT_HOLOGRAPHIC_REMOTING_EXTENSION_NAME "XR_MSFT_holographic_remoting"
    ...
    // extends XRReferenceSpaceType
    typedef enum XrRemotingReferenceSpaceType
    {
        XR_REMOTING_REFERENCE_SPACE_TYPE_USER_MSFT = 1000065000,
        XR_REMOTING_REFERENCE_SPACE_TYPE_MAX_ENUM = 0x7FFFFFFF
    } XrRemotingReferenceSpaceType;
    ...
    typedef enum XrRemotingDisconnectReasonMSFT
    {
        ...
        XR_REMOTING_DISCONNECT_REASON_HANDSHAKE_PERMISSION_DENIED_MSFT = 28,
